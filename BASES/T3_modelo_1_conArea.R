...
g5 <- ggplot(data = Bogota_train, mapping = aes(x = rooms_tot, y= price))+
  geom_point(col = "darkblue" , size = 0.9)+
  labs(x = "Habitaciones",
       y = "Precio ($)",
       title = "Relacion Precio - Habitaciones")+
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))

g5

g6 <- ggplot(data = Bogota_train, mapping = aes(x = bathrooms, y= price))+
  geom_point(col = "darkblue" , size = 0.9)+
  labs(x = "Banos",
       y = "Precio ($)",
       title = "Relacion Precio - Banos")+
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
